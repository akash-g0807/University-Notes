...
\begin{align*}
	K_{tot} = \frac{1}{2}\sum\limits_{i=1}^{N}m_{i}\mid \underline{\dot{r_{i}}} \mid^{2} & \Rightarrow K_{tot} = \frac{1}{2} \sum\limits_{i=1}^{N}m_{i}\mid \underline{\dot{R}} +\underline{\dot{s_{i}}} \mid^2                                                                                  \\ \\
	                                                                                     & \Rightarrow K_{tot} = \frac{1}{2}\sum\limits_{i=1}^{N}\Big[m_{i}\mid \underline{R} \mid^{2} + m_{i}2\underline{\dot{R}} \cdot \underline{s_{i}} +m_{i}\mid s_{i} \mid\Big] \label{eq: si-zero}\tag{1}
\end{align*}
